...
10. Open het bestand 'index.html' en plaatst daarin op de gewenste plaats het volgende html fragment:
...
Natuurlijk kent het Respec document nog een aantal secties die nog aangepast danwel vervangen moeten worden. Deels gebeurd dat door 'index.html' aan te passen en deels door de configuration property 'content' aan te passen. Beide methodes vullen elkaar aan en kennen eigen functionaliteiten. 

M.b.v. de 'content' property kunnen alleen secties waarvan de content in md bestanden staat worden toegevoegd. In deze property kan per bestand worden aangegeven of die sectie informatief is. Is dat het geval dan wordt automatisch de tekst 'Dit onderdeel is niet normatief.' aan het hoofdstuk toegevoegd.
...
Aangezien het gegenereerde Respec bestand geen md bestand is moet het worden toegevoegd aan het index.html bestand. Het 'index.html' kent daarnaast nog een aantal andere secties, te weten:
* De 'abstract' sectie.  
